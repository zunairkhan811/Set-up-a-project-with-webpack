...
# 📖 [Set-Up-a-Project-with-webpack] <a name="about-project"></a>



**[Add-Books-javascript-Project]** is a project to demonstrate how to use webpack.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

In This project webpack has been used and files are served using webpack according to project requirements.
...
```sh
  cd my-folder
  git clone https://github.com/zunairkhan811/Set-up-a-project-with-webpack.git
```
